...
string = '\n' + '(1) ' + '<a href=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[0]] + '.wav' + '\">' + FILENAMES[ids[0]] + '</a>'+ \
'\n' + '<audio src=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[0]] + '.wav' + '\" controls>' + '</audio>' + \
'\n' + '(2) ' + '<a href=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[1]] + '.wav' + '\">' + FILENAMES[ids[1]] + '</a>'+ \
'\n' + '<audio src=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[1]] + '.wav' + '\" controls>' + '</audio>' + \
'\n' + '(3) ' + '<a href=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[2]] + '.wav' + '\">' + FILENAMES[ids[2]] + '</a>'+ \
'\n' + '<audio src=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[2]] + '.wav' + '\" controls>' + '</audio>' + \
'\n' + '(4) ' + '<a href=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[3]] + '.wav' + '\">' + FILENAMES[ids[3]] + '</a>'+ \
'\n' + '<audio src=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[3]] + '.wav' + '\" controls>' + '</audio>' + \
'\n' + '(5) ' + '<a href=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[4]] + '.wav' + '\">' + FILENAMES[ids[4]] + '</a>'+ \
'\n' + '<audio src=\"' + '../log_mel_44.1k_data/second_half_audio/ai/' + FILENAMES[ids[4]] + '.wav' + '\" controls>' + '</audio>'
string = string.replace('\n','<br />\n')
print(string)